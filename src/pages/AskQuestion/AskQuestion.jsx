...
const paymentHandler = async (plan) => {
  try {
    const response = await fetch("https://project-res3.onrender.com", {
      method: "POST",
      body: JSON.stringify({
        plan,
      }),
    ...
    const options = {
      ...
      handler: async (response) => {
        ...
        const validateRes = await fetch("https://project-res3.onrender.com", {
          method: "POST",
        ...
        if (jsonRes.msg === 'success') {
          const res = await fetch('https://project-res3.onrender.com', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json',
              },
  ...
  return (
        ...
        <div className="ask-question">
            <div className="ask-ques-container">
               ...
               <form onSubmit={handleSubmit}>
                <div className="ask-form-container">
                    <label htmlFor="ask-ques-title">
                        ...
                        <input type="text" id='ask-ques-title' onChange={(e) => {setQuestionTitle(e.target.value)}} placeholder='e.g. Is there an R function the index of an element in a vector?'/>
                    </label>
               ...
               <div>
               <button onClick={() => paymentHandler('FREE')}>Free Plan (₹0/1 question per day)</button>
          <button onClick={() => paymentHandler('SILVER')}> Silver Plan (₹100/month, 5 questions per day)</button>
          <button onClick={() => paymentHandler('GOLD')}>Gold Plan (₹1000/month, unlimited questions)</button>
        </div>
